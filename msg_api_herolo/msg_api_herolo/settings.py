"""
Django settings for msg_api_herolo project.
...
ROOT_URLCONF = 'msg_api_herolo.urls'
...
WSGI_APPLICATION = 'msg_api_herolo.wsgi.application'
...
LOGIN_REDIRECT_URL = 'msg_app:home'

LOGIN_URL = 'users_app:login_request'
